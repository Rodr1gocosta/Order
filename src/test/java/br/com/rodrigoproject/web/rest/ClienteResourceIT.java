...
class ClienteResourceIT {
    ...
    public void cleanupElasticSearchRepository() {
        ...
        assertThat(clienteSearchRepository.count()).isEqualTo(0);
    }
    ...
    void createCliente() throws Exception {
        ...
        int searchDatabaseSizeBefore = IterableUtil.sizeOf(clienteSearchRepository.findAll());
        // Create the Cliente
        ...
        await()
            ...
            .untilAsserted(() -> {
                int searchDatabaseSizeAfter = IterableUtil.sizeOf(clienteSearchRepository.findAll());
    ...
    void putExistingCliente() throws Exception {
        ...
        await()
            ...
            .untilAsserted(() -> {
                int searchDatabaseSizeAfter = IterableUtil.sizeOf(clienteSearchRepository.findAll());
                assertThat(searchDatabaseSizeAfter).isEqualTo(searchDatabaseSizeBefore);
                List<Cliente> clienteSearchList = IterableUtils.toList(clienteSearchRepository.findAll());
                Cliente testClienteSearch = clienteSearchList.get(searchDatabaseSizeAfter - 1);
            });
    }
